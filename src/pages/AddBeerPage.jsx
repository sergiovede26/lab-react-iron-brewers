...
import API_URL from "../constanst/constants";
...
function AddBeerPage(props) {
  ...
  const handleSubmit = (e) => {
    ...
    const currenBeertId = parseInt(props.beerId);
    ...
    axios
      ...
      .catch((e) => console.log("error creating adding new Beer...", e));
  };
